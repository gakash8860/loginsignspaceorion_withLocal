...
class _ScheduledPinState extends State<ScheduledPin> {
  ...
  Future getScheduledPins() async {
    ...
    print("ScheduledPins $getUidVariable");
    // String token = "16661fcd5d214e43471bc304899f41c2ec2b811c";
    final url =
        API + 'schedulingpinsalltheway/?user=2' + getUidVariable.toString();
    try {
  ...
  Future schedulingDevicePin(var postData) async {
    const url = 'http://genorion1.herokuapp.com/schedulingpinsalltheway/';
    String token = await getToken();
  ...
  Future deleteSchedulingUsingIdWeb(String id) async {
    String token = await getTokenWeb();
    String url =
        API + 'schedulingpinsalltheway/?user=${getUidVariable}&id=${id}';
    final response = await http.delete(url, headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
      'Authorization': 'Token $token',
            ...
            child: FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.connectionState == ConnectionState.done) {
                    if (listOfScheduledPinsWeb == null ||
                        listOfScheduledPinsWeb.isEmpty) {
                      return Column(
                        children: [
                          SizedBox(
                            height: 250,
                          ...
                          Expanded(
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    print(
                                        'length ${listOfScheduledPinsWeb.length}');
                                    getPinsName(
                                        listOfScheduledPinsWeb[index]['d_id']);
                                    return Padding(
                                                            ...
                                                            if (listOfScheduledPinsWeb[
                                                              ...
                                                              postData = {
                                                                ...
                                                                "timing1": cutTime
                                                                    .toString(),
                                                                "d_id":
                                                                    listOfScheduledPinsWeb[
                                                                            index]
                                                                        [
                                                                        'd_id'],
                                                                "id": listOfScheduledPinsWeb[
                                                                        index]
                                                                    ['id'],
                                                                "pin1Status":
                                                                    checkSwitch,
                                                              ...
                                                              Navigator.pop(
                                                                  context);
                                                              return;
                                                            } else if (listOfScheduledPinsWeb[
                                                                        index][
                                                                    'pin2Status'] !=
                                                                null) {
                                                              postData = {
                                            ...
                                            children: [
                                              ListTile(
                                                ...
                                                leading: IconButton(
                                                  ...
                                                  onPressed: () async {
                                                    await deleteSchedulingUsingIdWeb(
                                                        listOfScheduledPinsWeb[
                                                                index]['id']
                                                            .toString());
                                                  },
                                                ...
                                                onTap: () {
                                                  print(
                                                      'printSubUser ${listOfScheduledPinsWeb[index]['id']}');
                                                            ...
                                                            onPressed:
                                                              ...
                                                              if (listOfScheduledPins[
                                                                ...
                                                                postData = {
                                                                  ...
                                                                  "timing1": cutTime
                                                                      .toString(),
                                                                  "d_id": listOfScheduledPins[
                                                                          index]
                                                                      ['d_id'],
                                                                  "id": listOfScheduledPins[
                                                                          index]
                                                                      ['id'],
                                                                  "pin1Status":
                                                                      checkSwitch,
                                              ...
                                              children: [
                                                ListTile(
                                                  ...
                                                  leading: IconButton(
                                                    ...
                                                    onPressed: () async {
                                                      await deleteSchedulingUsingId(
                                                          listOfScheduledPins[
                                                                  index]['id']
                                                              .toString());
                                                      await getScheduledPins();
                                                    },
                                                  ),
                                                  subtitle: Text(
                                                    listOfScheduledPins[index]
                                                  ...
                                                  onTap: () {
                                                    print(
                                                        'printSubUser ${listOfScheduledPins[index]['id']}');
