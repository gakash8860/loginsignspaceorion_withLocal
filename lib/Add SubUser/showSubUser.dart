      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          MaterialButton(onPressed: (){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>AddSubUser()));
          }, child: Text('Add SubUser',style: TextStyle(
              fontSize: 15
          ),)),
          MaterialButton(onPressed: (){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>AlreadySubUser()));
                    ...
                    if(snapshot.hasData){
                      if(subUserDecodeList.contains('empty')){
                        return Column(
                          children: [
                            SizedBox(height: 250,),
                            Center(child: Text('Sorry we cannot find any sub User please add',style: TextStyle(fontSize: 18),)),
                          ],
                        );
                      }else{
                        return Column(
                                    ...
                                    child: Card(
                                      ...
                                      child: ListTile(
                                        ...
                                        onTap: (){
                                          ...
                                          // placeName=
                                          Navigator.push(context, MaterialPageRoute(builder: (context)=>SubUserDetails(subUserPlaceId: subUserDecodeList[index]['p_id'],subUserEmail: subUserDecodeList[index]['email'],subUserName: subUserDecodeList[index]['name'],)));
