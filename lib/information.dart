                ...
                child: SizedBox(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        Pin(start: 18.0, end: 16.0),
                        Pin(size: 226.0, middle: 0.5451),
                        child: Scrollbar(
                          child: SingleChildScrollView(
                            child: Text(
