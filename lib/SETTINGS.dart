...
void main() => runApp(MaterialApp(home: SETTINGS()));
...
class _SETTINGSState extends State<SETTINGS> {
  ...
  adminData()async{
    adminDetails= await NewDbProvider.instance.userQuery();
    setState(() {
      adminName=adminDetails[0]['first_name'];
    });
    print('admin ${adminDetails[0]['first_name']}' );
  }
                            ...
                            children: <Widget>[
                              Pinned.fromPins(
                                ...
                                child: Container(
                                  ...
                                  child: Text('aaaa',style:TextStyle(fontSize:99)),
                                ),
                              ),
                              Pinned.fromPins(
